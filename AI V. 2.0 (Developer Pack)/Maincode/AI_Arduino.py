...
label.pack(side=TOP)
filename = PhotoImage(file="C:\\Users\\praso_\\Dropbox\\My PC (LAPTOP-2R3CKJJJ)\\Desktop\\AI V. 2.0 (Developer Pack)\\Maincode\\AnyConv.com__AnyConv.com__AI.png")
...
def Contri():
    tkinter.messagebox.showinfo("Contributors","The AI was made by Prasoon rai and Pranjal rai.Prasoon rai wrote the main codes and Pranjal rai made the design for the AI.")
...
subm2.add_command(label="Rate Us",command=rate)
...
but5=Button(frame,padx=5,pady=5,width=5,bg='white',fg='black',relief=GROOVE,text=a,command=Open,font=('helvetica 15 bold'))
